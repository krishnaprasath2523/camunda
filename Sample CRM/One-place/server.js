...
// const { startInstance } = require('./zeebe');
...
app.post("/newclient", async (req, res) => {
  ...
  // Promise.resolve(queryAddingNewClient).then((data, resolve) => {
...
console.log(`Complete initialization of the server`);
...
//       console.log('first has', hash)
//       err && console.log('error:', err)
//       bcrypt.compare(myPlainTextPassword, hash).then((compared) => {
//         console.log('first has verify', compared);
//       });
//   });
// });
