...
function Clients() {
  ...
  const AddClients = () => {
    const DEFAULT_DETAILS = {
      clientName: "",
      clientDetails: "General Product Enquiry",
      phone: "",
      street: "",
      city: "",
      country: "India",
    ...
    const [clientDetails, setClientDetails] = useState(DEFAULT_DETAILS);
    let connector = "https://syd-1.connectors.camunda.io/45dbe208-75ec-40f4-863b-cf2feb7f32e4/inbound/save-client-application-ce5f89dd-7fda-48a7-be38-716c65a33652?";
    connector += "clientName=" + clientDetails.clientName;
    connector += "&clientDetails=" + clientDetails.clientDetails;
    connector += "&phone=" + clientDetails.phone;
    connector += "&street=" + clientDetails.street;
    connector += "&city=" + clientDetails.city;
    connector += "&country=" + clientDetails.country;
    connector += "&postalCode=" + clientDetails.postalCode;
    connector += "&workerName=" + clientDetails.workerName;
      ...
      axios.get(connector)
        .then((response) => {
          ...
          if (response?.data === "success") {
            setClientDetails(DEFAULT_DETAILS);
